...
import { updateReservationStatus } from "@/hooks/useReservation";
...
export default function ModalDrawer({
  ...
  const handleCheckout = async () => {
    ...
    const payload = {
      ...
      notes: values.additionalNotes || "", // Include additional notes
    };

    try {
      await updateReservationStatus(payload, resourceId, token);
      onCheckoutSuccess();
      onClose();
    } catch {
